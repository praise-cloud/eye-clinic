...
const MainApp = () => {
  ...
  return (
    <>
      ...
      {/* Modals */}
      {modals.addPatient && (
        <AddPatientModal onClose={() => closeModal('addPatient')} />
      )}
      {modals.uploadTest && (
        <UploadTestModal onClose={() => closeModal('uploadTest')} />
      )}
      {modals.generateReport && (
        <GenerateReportModal onClose={() => closeModal('generateReport')} />
      )}
      {modals.newMessage && (
        <NewMessageModal onClose={() => closeModal('newMessage')} />
      )}
    </>
  )
}
